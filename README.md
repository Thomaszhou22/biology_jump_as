...
- **答题**：发起移动前会弹出随机 A Level AS 生物题（四选一：一个正确选项 + 三个干扰项）；答对后才能落子。答错可记入错题本（见 **Wrong Question Notebook**）。管理员可开「All Answers Correct」跳过判题（仅调试用）。
...
> ⚠️ 当前仓库为**空白题库版本**，需要自行添加 A Level AS 生物相关题目。
---
## 管理员系统（重点）
